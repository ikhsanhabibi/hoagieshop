...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { comment: @feedback.comment, image: @feedback.image, rating: @feedback.rating } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { comment: @feedback.comment, image: @feedback.image, rating: @feedback.rating } }
